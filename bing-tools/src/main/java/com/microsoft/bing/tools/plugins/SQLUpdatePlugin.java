package com.microsoft.bing.tools.plugins;

import com.microsoft.bing.tools.utils.SnowflakeIdWorker;
...
@Component
@Slf4j(topic = "mybatis update拦截器 id")
@Intercepts({@Signature(type = Executor.class,method = "update",args = {MappedStatement.class,Object.class})})
public class SQLUpdatePlugin implements Interceptor  {
